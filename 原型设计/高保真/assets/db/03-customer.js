...
window.DB.customer = {
  ...
  companies: [
    ...
    /* 撞码合并演示：误录入的重复公司档案（墓碑，mergedInto→C2001，物理不删） */
    { id: 'C2099', fullName: '杭州云启网络科技有限公司', shortName: '云启网络', creditCode: null,
      industryL1: '信息技术', industryL2: '软件服务', province: '浙江', city: '杭州', scale: '中型',
      completeness: { c1: 60, c2: 0, c3: 0 }, missingFields: ['bank_name', 'invoice_title', 'tax_no', 'credit_code'],
      identityTagCodes: [], policyTagCodes: [], decisionChain: 'unknown',
      businessLineCount: 1, totalValue: 40000, firstSignAt: null, website: '',
      address: '杭州市西湖区文三路 100 号', contactIds: ['P3001'],
      mergedInto: 'C2001', mergedAt: '2026-09-10 14:30', aliases: ['杭州云启网络科技有限公司'],
      mergedReason: '补录统一信用代码 91330106MA27X****1 与「云启科技」撞码' },
