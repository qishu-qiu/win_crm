...
export const ErrorCode = {
  ...
  /**
   * 422 · 跨部门 @求助（@求助**仅限同部门**，跨部门须走正式协同审批，→ 需求 §4.3 / 废止口径 #10）。
   * ★ 2026-09-15 补：规格原文只写了规则、**没给错误码**（七叔授权「没定义你可补充」），
