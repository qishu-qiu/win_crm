...
//
// 口径来源（★ 真相源，勿自造）：
//   · 《销售CRM架构设计说明》§7.3 脱敏渲染（**判定在 kernel、渲染在各域出口** —— 2026-09-15 校正，
//     原文「出口统一处理」已作废）＋ §7.1（横切层**只读上下文、不查库**）。
//   · 《销售CRM业务需求文档》§4.3：联系方式（默认全可见 ＋ 联系人可上锁）· 跟单全文（跨部门互不可见）·
//     金额（跨业务线脱敏）· ★ **报表 / 看板 / 汇总不脱敏**（经理 / 老板出口，2026-09-11 定）。
//   · 《销售CRM数据架构文档》§十一 ＋《接口API文档》§2.8：字段级**出参形态**。
