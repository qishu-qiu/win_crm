...
- **★ 公海（无主）关系 ＝ 可读不可写（2026-09-18 定）**：
  ...
  - **唯一例外 ＝ `PUT /relations/:id` 只传 `value_tier`**（改「开发价值」），其余字段一起传也算写 → `20408`。
